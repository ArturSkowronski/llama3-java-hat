 ...
 *
 * This test enables ONLY the SiLU kernel for HAT dispatch while keeping all other kernels
 * in plain Java mode. This isolates whether SiLU HAT dispatch works correctly in the full
 * inference pipeline or triggers the data visibility bug observed in earlier experiments.
 *
 * Success criteria:
 * - Test completes without exception
 * - Response is coherent English text (not gibberish like "{{{{...")
...
public class ChatIntegrationTestWithSiLUHAT {
    ...
    public void testChatWithSiLUHAT() throws IOException {
        ...
        // Create factory with ONLY SiLU HAT enabled
