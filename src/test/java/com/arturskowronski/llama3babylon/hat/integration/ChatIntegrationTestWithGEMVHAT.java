 ...
 * - Known buffer bounds caching bug in HAT Java Sequential Backend
 * - Workaround: LlamaInference already primes with largest matrix (classifier 128256×2048)
 *
 ...
 *
 * Success criteria:
 * - Test completes without exception (no buffer bounds errors)
